"""
Django settings for exercise_meter project.
...
ROOT_URLCONF = 'exercise_meter.urls'
...
WSGI_APPLICATION = 'exercise_meter.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'green_house_management/static'),
)
